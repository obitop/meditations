[
    ...
    'From my mother, piety and beneficence, and abstinence, not only from evil deeds, but even from evil thoughts; and further, simplicity in\n' +
    'my way of living, far removed from the habits of the rich',
    'From my great-grandfather, not to have frequented public schools, and to have had good teachers at home, and to know that on such things\n' +
    'a man should spend liberally',
    'From my governor, to be neither of the green nor of the blue party at the games in the Circus, nor a partizan either of the Parmularius\n' +
    ...
    'From Diognetus, not to busy myself about trifling things, and not to give credit to what was said by miracle-workers and jugglers about\n' +
    ...
    'From Rusticus I received the impression that my character required improvement and discipline; and from him I learned not to be led astray\n' +
    ...
    'From Apollonius I learned freedom of will and undeviating steadiness of purpose; and to look to nothing else, not even for a moment, except\n' +
    ...
    'From Alexander the grammarian, to refrain from fault-finding, and not in a reproachful way to chide those who uttered any barbarous\n' +
    ...
    'From Fronto I learned to observe what envy, and duplicity, and hypocrisy are in a tyrant, and that generally those among us who are called\n' +
    ...
    'From Catulus, not to be indifferent when a friend finds fault, even if he should find fault without reason, but to try to restore him\n' +
    ...
    'truly',
    'From my brother Severus, to love my kin, and to love truth, and to love justice; and through him I learned to know Thrasea, Helvidius,\n' +
    ...
    'and to do what was set before me without complaining',
    'I observed that everybody believed that he thought as he spoke, and that in all that\n' +
    ...
    'He was accustomed to do acts of beneficence, and was ready to forgive, and was free from all falsehood; and he presented the appearance of\n' +
    'a man who could not be diverted from right rather than of a man who\n' +
    'had been improved',
    'I observed, too, that no man could ever think that he was despised by Maximus, or ever venture to think himself a better\n' +
    'man',
    'He had also the art of being humorous in an agreeable way',
    'In my father I observed mildness of temper, and unchangeable resolution in the things which he had determined after due deliberation; and\n' +
    ...
    'And I observed that he had overcome all passion for boys; and he considered himself no more than any other citizen; and he released his friends\n' +
    ...
    'I observed too his habit of careful inquiry in all matters of deliberation, and\n' +
    ...
    'nor love of novelty',
    'And the things which conduce in any way to the commodity of life, and of which fortune gives an abundant supply,\n' +
    ...
    'them not, he did not want them',
    'No one could ever say of him that he was either a sophist or a home-bred flippant slave or a pedant;\n' +
    'but every one acknowledged him to be a man ripe, perfect, above flattery,\n' +
    "able to manage his own and other men's affairs",
    'Besides this, he honoured those who were true philosophers, and he did not reproach those who\n' +
    'pretended to be philosophers, nor yet was he easily led by them',
    'He was also easy in conversation, and he made himself agreeable without\n' +
    'any offensive affectation',
    "He took a reasonable care of his body's health, not as one who was greatly attached to life, nor out of regard\n" +
    ...
    'He was most ready to give way without envy to those who possessed any particular faculty,\n' +
    ...
    'of doing so',
    'Further, he was not fond of change nor unsteady, but he loved to stay in the same places, and to employ himself about the\n' +
    'same things; and after his paroxysms of headache he came immediately\n' +
    'fresh and vigorous to his usual occupations',
    'His secrets were not but very few and very rare, and these only about public matters; and\n' +
    ...
    'His dress came from Lorium, his villa on the coast, and from Lanuvium generally',
    'We know how he behaved to the toll-collector at Tusculum who asked his pardon;\n' +
    'and such was all his behaviour',
    'There was in him nothing harsh, nor implacable, nor violent, nor, as one may say, anything carried to\n' +
    ...
    'and consistently',
    'And that might be applied to him which is recorded of Socrates, that he was able both to abstain from, and to enjoy,\n' +
    'those things which many are too weak to abstain from, and cannot enjoy\n' +
    'without excess',
    'But to be strong enough both to bear the one and to be sober in the other is the mark of a man who has a perfect and invincible\n' +
    'soul, such as he showed in the illness of Maximus',
    'To the gods I am indebted for having good grandfathers, good parents, a good sister, good teachers, good associates, good kinsmen and friends,\n' +
    'nearly everything good',
    'Further, I owe it to the gods that I was not hurried into any offence against any of them, though I had a disposition\n' +
    ...
    "Further, I am thankful to the gods that I was not longer brought up with my grandfather's concubine,\n" +
    ...
    'that befits a ruler',
    'I thank the gods for giving me such a brother, who was able by his moral character to rouse me to vigilance over\n' +
    ...
    'and giddiness',
    '; and that, when I had an inclination to philosophy, I did not fall into the hands of any sophist, and that I did not waste\n' +
